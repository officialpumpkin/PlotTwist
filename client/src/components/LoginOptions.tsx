...
export default function LoginOptions() {
  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-sm border border-neutral-200 max-w-md mx-auto">
      <h2 className="text-2xl font-bold text-center mb-6">Log in to StoryWeave</h2>
      <p className="text-neutral-600 text-sm text-center mb-8">
        Choose how you'd like to sign in to StoryWeave to start collaborating on stories.
      </p>
