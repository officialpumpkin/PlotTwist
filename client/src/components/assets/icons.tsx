...
export const QuillPenIcon = ({ className }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="none"
    ...
    className={cn("h-5 w-5", className)}
  >
    <path d="M20 17V5c0-1.1-.9-2-2-2H8L2 9v10c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2z" />
    <path d="M2 9h4V5" />
    <path d="M17 7 7.11 15.9" />
    <path d="M17 7v10H7V7" />
  </svg>
);
...
export const BookletIcon = ({ className }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="none"
    ...
    className={cn("h-5 w-5", className)}
  >
    <path d="M20 22H6c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h14v20Z" />
    <path d="M20 22V2" />
  </svg>
);
